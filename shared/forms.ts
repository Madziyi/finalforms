...
export const FORMS: FormDefinition[] = [
  ...
  },
  {
    ...
    sections: [
      section("weather", "Outside Air Temperature", [
        n("oat_high", "OAT High", { unit: "°F", calculated: true, optional: true, helpText: "Derived from completed Form 9 O.A.T. Memorial readings for this date." }),
        n("oat_low", "OAT Low", { unit: "°F", calculated: true, optional: true, helpText: "Derived from completed Form 9 O.A.T. Memorial readings for this date." }),
      ]),
